...
set $key to the primary key of the view. Or any unique value in the view. This is used in the edit, and more functions
so that the CommiteeView class can send you a single record that you can view and edit.

set $view to the name of the table or view as shown in phpMyAdmin. I have not tested it with putting a raw query in it.
It might work but It would be safer to create a view in phpMyAdmin by using the query CREATE VIEW viewName AS <Insert select query here>
*/
$key="Person_ID";
