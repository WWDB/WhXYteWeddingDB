<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  $sql = "SELECT Person.Email, Volunteer.password FROM Person INNER JOIN Volunteer ON Volunteer.Person_ID=Person.Person_ID WHERE Person.Email='$myusername' and Volunteer.Password ='$mypassword'"; 
...
<html>
   ...
   <body bgcolor = "#FFFFFF">
	...
	<div align="center" class="container" style="background-color:#ffffff">
